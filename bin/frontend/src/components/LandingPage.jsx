        ...
        <div className="row align-items-center min-vh-100">
          <div className="col-lg-6 text-start pe-lg-5">
            ...
            <p className="text-muted fs-5 mb-5 pe-lg-5" style={{ lineHeight: '1.6' }}>
              Streamline your hiring process with our comprehensive platform. Effortlessly coordinate with candidates, manage multiple interview rounds, and make data-driven hiring decisions—all in one place.
            </p>
